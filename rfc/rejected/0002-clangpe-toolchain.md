...
- [2026-06-22]: Changed state to [Rejected](#rejection-summary)
...
In a recent stewards meeting, the following decisions were made regarding this RFC:

1. Everyone would really like to get to a single CLANGPE toolchain definition - that's considered unrealistic right now
due to downstream platform support.
2. There was concern that clang-cl cannot be used for host apps and unit tests.
3. In general, everyone was appreciative of the work done, but the conclusion was to pause the work until clang-cl has
full MSVC arg-compatibility.
